...
import { toggleCategoryArchive } from "@/app/admin/(protected)/catalogue-actions";
...
export default async function AdminCategoriesPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      ...
      <h1 className="font-display mt-2 text-5xl font-bold">Categories</h1>
      <p className="mt-3 max-w-2xl text-[var(--muted)]">
        Shape how students discover the catalogue. Categories with active
        products stay protected from archiving.
      </p>
      <section className="surface-card mt-8 p-5 sm:p-7">
        <h2 className="font-display text-3xl font-bold">Add a category</h2>
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <form
                    action={toggleCategoryArchive.bind(
                      null,
                      category.id,
                      !category.archived,
                    )}
                  >
                    <button
                      ...
                      type="submit"
                      disabled={!category.archived && category.productCount > 0}
                      title={
                        !category.archived && category.productCount > 0
                          ? "Archive or move its products first"
                          : undefined
                      }
                    >
                      {category.archived ? (
