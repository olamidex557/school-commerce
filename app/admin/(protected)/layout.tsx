      ...
      <header className="sticky top-0 z-30 border-b border-[var(--line)] bg-[color:var(--surface)]/94 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3 sm:px-8">
          <div className="flex min-w-0 items-center gap-3">
            <span className="grid h-9 w-9 shrink-0 place-items-center rounded-[.75rem] bg-[var(--ink)] text-xs font-black text-[var(--highlight)]">
              CA
            </span>
          ...
          <div className="flex items-center gap-3">
            <nav
              ...
              className="hidden gap-1 text-sm font-bold sm:flex"
            >
              <Link
